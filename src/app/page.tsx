...
const companies = [
    {
        name: 'PassportCard',
        description:
            'החברה שמשלמת במקום ללא השתתפות עצמית. מקבלים כרטיס מגנטי ומשלמים איתו על הוצאות רפואיות בחו"ל.',
        link: 'https://buy.passportcard.co.il/existing?AffiliateId=9sCy4Fmb8d7faRqj8E2F8w%3D%3D',
    },
    {
        name: 'הראל',
        description:
            'ביטוח הנסיעות הפופולרי ביותר. ניהול תביעות נוח דרך אפליקציית Harel First ומענה רפואי רחב.',
        link: 'https://digital.harel-group.co.il/travel-policy?guid=bee1d408-c6a7-410e-b4ee-ac690224bdd3&an=021945',
    },
    {
        name: 'הפניקס Smart',
        description:
            'התאמה חכמה של הפוליסה ליעד שלכם. כולל כיסוי למצבים רפואיים קיימים ושירות לקוחות זמין.',
        link: 'https://travel.agentsfnx.co.il/travel/landing.html?fnx_ANum=TCIqlTMYYFg%3d&referrer=meitav-ins.co.il#',
    },
    {
        name: 'מגדל',
        description:
            'כיסוי מקיף ומקצועי. פתרונות ייחודיים לתרמילאים, ספורט אתגרי ומשלחות עסקיות.',
        link: '#',
    },
    {
        name: 'כלל ביטוח',
        description:
            'מסלולים משפחתיים משתלמים. פריסת שירותים בינלאומית רחבה ומחירים תחרותיים.',
        link: 'https://www.clalbit.co.il/travelingisurance/claltravel/?txtCompID=1&txtItemID=6b05de62-677c-4942-9de9-6e9a0375a73f',
    },
    {
        name: 'מנורה מבטחים',
        description:
            'גב כלכלי חזק ושירות מעולה. פוליסות גמישות המעניקות ראש שקט בכל נסיעה.',
